...
export const LoadingScreen = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-gradient-to-br from-purple-600/20 to-blue-500/20 text-gray-200 flex flex-col items-center justify-center">
      <div className="mb-4 text-xl md:text-5xl font-mono font-bold">
